...
import { renderEffectText } from '../../utils/renderEffectText'
    ...
    <div className="station-inner">
      ...
      <div className="station-right">
        <div className="station-art-wrap">
          <CardArtwork artwork={card.artwork} theme={theme} nombre={card.nombre} framed />
          {!card.artwork && <span className="station-art-caption">Estación · Arte IA</span>}
        </div>
